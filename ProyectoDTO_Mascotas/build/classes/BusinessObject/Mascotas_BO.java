...
public class Mascotas_BO {
    ...
    public Mascotas_BO() {
        ...
        Mascota_VO mascota1 = new Mascota_VO(123458, 2 , "Laica", " Perro", "Labrador");
        Mascota_VO mascota2 = new Mascota_VO(3123, 9,"Priscila", "Gato", "Persa");
        Mascota_VO mascota3 = new Mascota_VO(123123, 5 ,"Rodolfito", "Ave", "Perico");
