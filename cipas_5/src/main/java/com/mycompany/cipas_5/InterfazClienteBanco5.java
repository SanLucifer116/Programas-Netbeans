...
public class InterfazClienteBanco5 {
    ...
    public static void decreAhorro() {
        double prom = 0.0, acu = 0.0;
        int pos=0;
        if (cont == 0) {
            JOptionPane.showMessageDialog(null, "ERROR... NO HAY CLIENTES");
        } else {
            ...
            while (pos<cont) {
                ...
                if (ArregloCliente[pos].getTipoCuenta().equalsIgnoreCase("Ahorro")) {
                    
                    prom = ArregloCliente[pos].getCapital() * 0.02;
                    acu = acu + prom;
                    ArregloCliente[pos].setCapital(ArregloCliente[pos].getCapital() - prom);
        ...
        for (int i = 0; i < cont; i++) {
            ...
            if (ArregloCliente[i].getTipoCuenta().equalsIgnoreCase("Ahorro")) {

                JOptionPane.showMessageDialog(null, "Clientes con Cuentas Corrientes" + "\n--------------\n"
                        + "\n Numero de Cuenta: " + ArregloCliente[i].getNumCuenta()
                        + "\n Cedula: " + ArregloCliente[i].getNumCed()
                        + "\n Cliente" + ArregloCliente[i].getNombre() + "\n  Capital " + ArregloCliente[i].getCapital()
                        + "\n Tipo de cuenta Corriente: " + ArregloCliente[i].getTipoCuenta());
                
            }
        }
        JOptionPane.showMessageDialog(null, "Decremento Total de Todos los Clientes con Cuenta Ahorro = " + acu);
